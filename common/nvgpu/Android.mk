...
ifneq ($(TARGET_TEGRA_GPU),nvgpu-r29)
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES            := bin64/hw/vendor.nvidia.hardware.graphics.composer@2.0-service
...
include $(CLEAR_VARS)
LOCAL_MODULE               := vendor.nvidia.hardware.graphics.composer@2.0-service.rc
LOCAL_SRC_FILES            := etc/init/vendor.nvidia.hardware.graphics.composer@2.0-service.rc
...
LOCAL_SRC_FILES            := lib64/vendor.nvidia.hardware.graphics.composer@2.0.so
LOCAL_MODULE_SUFFIX        := .so
LOCAL_MODULE_CLASS         := SHARED_LIBRARIES
LOCAL_MODULE_TARGET_ARCH   := arm64
LOCAL_MODULE_TAGS          := optional
...
LOCAL_SRC_FILES            := lib64/vendor.nvidia.hardware.graphics.composer@2.0-impl.so
LOCAL_MODULE_SUFFIX        := .so
LOCAL_MODULE_CLASS         := SHARED_LIBRARIES
LOCAL_MODULE_TARGET_ARCH   := arm64
LOCAL_MODULE_TAGS          := optional
